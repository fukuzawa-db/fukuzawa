...
int main(){
	...
	Operator *o1, *o2, *o3, *o4, *o5, *o6, *o7, *o8, *o9, *o10, *o11, *o12, *o13;
...
/* Projection */
	...
	cout << "OK new o5" << endl;
	o6 = new OneSideHashJoin(o4, o5 , jpn2, 1);
	cout << "OK new o6" << endl;
	o7 = new Projection(pro3, 1);
	o7->setPreOperator(o6);
	cout << "OK new o7" << endl;
	

	o8 = new Scan(&db_o, attriRec_o, 9);
	cout << "OK new o8" << endl;
	o9 = new Selection((Node *)&an4 ,(unsigned int)2);
	cout << "OK new o9" << endl;
	o9->setPreOperator(o8);
	
	o10 = new OneSideHashJoin(o7, o9 , jpn3, 1);
	cout << "OK new o10" << endl;



	o11 = new OutPut(STD_OUT);
