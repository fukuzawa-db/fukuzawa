...
/* Projection8 */
	...
	OPERATION_NODE pro8[3];
	pro8[0].tableID = 8;
	pro8[0].attributeID = 1;
	pro8[1].tableID = 7;
	pro8[1].attributeID = 2;
	pro8[2].tableID = 6;
	pro8[2].attributeID = 4;
	pro8[3].tableID = 2;
	pro8[3].attributeID = 2;
...
/* Sort 2 */
	...
	o20 = new Projection(pro8, 4);
	o20->setPreOperator(o19);
	cout << "OK new o20" << endl;
	
	o22 = new Sort(so2, 3);
	o22->setPreOperator(o20);
