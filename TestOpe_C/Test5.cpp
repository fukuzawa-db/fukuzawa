...
int main(){
	...
	BDBOpe db_o_5("7.5.DSM_C");
	BDBOpe db_l_1("8.1.DSM_C");
	BDBOpe db_l_2("8.2.DSM_C");
	BDBOpe db_l_3("8.3.DSM_C");
...
/* Projection2 */
	...
	o16 = new ScanRLE(&db_o_5, &attriRec_o[4], 1);
	...
	o18 = new ScanFromJI_OneHash(o15, o17, &jon2);
	cout << "OK new o8" << endl;
	
	o19 = new ScanDSM(&db_o_1, &attriRec_o[0], 1);
	cout << "OK new o19" << endl;
	
	o20 = new ScanFromJI_OneHash(o18, o19, &jon3);
	cout << "OK new o20" << endl;

	o21 = new Projection(pro2, 1);
	o21->setPreOperator(o20);
	cout << "OK new o21" << endl;
	
	o22 = new ScanRLE(&db_l_1, &attriRec_l[0], 1);
...
/*
	...
	o28 = new ScanRLE(&db_l_2, &attriRec_l[1], 1);
	...
	o30 = new ScanDSM(&db_n2_1, &attriRec_n[0], 1);
	cout << "OK new o28" << endl;
	
	o31 = new ScanRLE(&db_s_4, &attriRec_s[3], 1);
	cout << "OK new o29" << endl;
	
	o32 = new JoinIndex_OneHash(o30, o31); 
...
/*
	...
	*/
	...
	cout << "OK new o5" << endl;
	*/
	o40 = new OutPut(STD_OUT);
	cout << "OK new o40" << endl;
	o40->setPreOperator(o23);
	o40->init();
