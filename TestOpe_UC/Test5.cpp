...
/* Projection4 */
	...
	o34 = new JoinIndex_OneHash(o32, o33); 
	cout << "OK new o34" << endl;
	
	o35 = new ScanDSM(&db_s_1, &attriRec_s[0], 1);
	cout << "OK new o35" << endl;
	
	o36 = new ScanFromJI(o35, o34, &op5);
	cout << "OK new o36" << endl;
	
	o37 = new ScanDSM(&db_l_3, &attriRec_l[2], 1);
	cout << "OK new o37" << endl;
	
	o38 = new JoinIndex_OneHash(o35, o37); 
	cout << "OK new o38" << endl;
	
	o39 = new Projection(pro4, 1);
	o39->setPreOperator(o38);
	cout << "OK new o39" << endl;
	
	o40 = new ScanFromJI(o39, o31, &op4);
	cout << "OK new o40" << endl;




	o41 = new OutPut(STD_OUT);
