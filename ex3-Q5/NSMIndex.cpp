...
/* Projection11 */
	...
	OPERATION_NODE pro11[3];
	pro11[0].tableID = 2;
	pro11[0].attributeID = 2;
	pro11[1].tableID = 7;
	pro11[1].attributeID = 1;
	pro11[2].tableID = 7;
	pro11[2].attributeID = 5;
...
/* Sort 1 */
	...
	o10 = new NestedJoin_Index(IS_o, o9, pn3);
	o11 = new Projection(pro11, 3);
	...
	o16 = new NestedJoin_Index(IS, o12, pro10);
