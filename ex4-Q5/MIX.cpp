...
int main(){
	...
	pf2 = S_1_secondary;
	sDB2 = new SecondDB(env->getEnv(), "3.1.secondary");
	sDB2->setNumCmp();
...
/* exec */
	...
	IndexScan *IS2 = new IndexScan((BDBOpe *)sDB2, attriRec_s, 7);
	o26 = new NestedJoin_Index(IS2, o26, pro11);
	o27 = new Selection((Node *)&an5 ,(unsigned int)2);
