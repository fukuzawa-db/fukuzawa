...
int main(){
	...
	pf1 = L_1_secondary;
	sDB1 = new SecondDB(env->getEnv(), "8.2.secondary");
	sDB1->setNumCmp();
...
/* Projection6 */
	...
	pro6[1].tableID = 8;
	pro6[1].attributeID = 3;
	pro6[2].tableID = 8;
	pro6[2].attributeID = 6;
	pro6[3].tableID = 8;
	pro6[3].attributeID = 7;
...
/* ======== Nested Loop Join with Index ============ */
	...
	o22 = new NestedJoin_Index(IS1, o27, idx1);
	//l_orderkey, l_suppkey, l_extentdedprice, l_discount
	o23 = new Projection(pro6, 4);
	o23->setPreOperator(o22);
	
/* ======================================================= */
	
	
	o29 = new OneSideHashJoin(o23, o21, &jon5, 1); 
