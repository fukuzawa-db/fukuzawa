...
int main(){
	...
	BDBOpe db_r_1(env->getEnv(), "10.1.DSM");
	BDBOpe db_r_2(env->getEnv(), "10.2.DSM");
	BDBOpe db_n_1(env->getEnv(), "11.1.DSM");
	BDBOpe db_n_2(env->getEnv(), "11.2.DSM");
	BDBOpe db_n_3(env->getEnv(), "11.3.DSM");
	BDBOpe db_s_1(env->getEnv(), "12.1.DSM");
	BDBOpe db_s_4(env->getEnv(), "12.4.DSM");
	BDBOpe db_c_1(env->getEnv(), "15.1.DSM");
	BDBOpe db_c_4(env->getEnv(), "15.4.DSM");
	BDBOpe db_o_1(env->getEnv(), "16.1.DSM");
	BDBOpe db_o_2(env->getEnv(), "16.2.DSM");
	BDBOpe db_o_5(env->getEnv(), "16.5.DSM");
	BDBOpe db_l_1(env->getEnv(), "17.1.DSM");
	BDBOpe db_l_3(env->getEnv(), "17.3.DSM");
	BDBOpe db_l_6(env->getEnv(), "17.6.DSM");
	BDBOpe db_l_7(env->getEnv(), "17.7.DSM");
